...
contract LenderTest is Test {
    ...
    function testFuzz_borrow(
        ...
        if (debtAmount > 1000 * 10 ** 18) {
            ...
            assertEq(
                collateralToken.balanceOf(address(lender)),
                collateralAmount
            );
            (, , , , uint256 poolBalance, , , , ) = lender.pools(poolId);
    ...
    function testFuzz_repay(uint256 loanLength) public {
        ...
        uint256 interest = ((p.interestRate * b.debt * loanLength) /
            10000 /
            365 days);
    ...
    function testFuzz_buyLoan(uint256 timeToBuy) public {
        ...
        uint256 maxInterest = (lender.MAX_INTEREST_RATE() * timeToBuy) /
            p.auctionLength;
